    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link href="{{ route('hote') }}" :active="request()->routeIs('hote')">
                        {{ __('Hotel') }}
                    </x-nav-link>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link href="{{ route('photosh') }}" :active="request()->routeIs('photosh')">
                        {{ __('Gallery') }}
                    </x-nav-link>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link href="{{ route('liver') }}" :active="request()->routeIs('liver')">
                        {{ __('Concert') }}
                    </x-nav-link>
                </div>

                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link href="{{ route('feter') }}" :active="request()->routeIs('feter')">
                        {{ __('Festivité') }}
                    </x-nav-link>
                </div>
            </div>
