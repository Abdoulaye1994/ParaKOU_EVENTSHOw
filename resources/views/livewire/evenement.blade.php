                    ...
                    <table class="table table-striped">
                      ...
                      <tr>
                        ...
                        <th scope="col">
                            <div class="col-md-10">
                               <div class="speaker">
                                  <img style="height: 50px; width: 50px;" class="img-fluid" src="{{Storage::url($Evente['image'])}}">
                               </div>
                          </div>
                        </th>
                        <th scope="col">
                        ...
                        <th>
                            <div class="col-sm-2 d-flex">
                               <button type="submit" value="save"   wire:click="updateEvente({{$Evente['id']}})"  class="btn btn-primary">Update</button>
                               <button type="submit" value="save" wire:click="deleteEvente({{$Evente['id']}})" class="btn btn-secondary">Delete</button>
                              </div>
