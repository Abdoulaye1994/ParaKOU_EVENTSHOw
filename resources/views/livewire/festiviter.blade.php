     ...
     <body>
        ...
        <div class="card">
            <div class="card-body">
              ...
              <form  wire:submit.prevent="fetesave" >
                    ...
                    <table class="table table-striped">
                      ...
                      <tr>
                        ...
                        <th scope="col">
                            <div class="col-md-10">
                               <div class="speaker">
                                  <img style="height: 50px; width: 50px;" class="img-fluid" src="{{Storage::url($Festivale['image'])}}">
                               </div>
                          </div>
                        </th>
                        <th scope="col">
                             <h4> {{$Festivale->titre}}</h4>
                        </th>

                        <th scope="col">
                            <p>  {{$Festivale->detail}} </p>
                        </th>

                        <th>
                            <div class="col-sm-2 d-flex">
                               <button type="submit" value="save"   wire:click="updatFestivale({{$Festivale['id']}})"  class="btn btn-primary">Update</button>
                               <button type="submit" value="save" wire:click="deleteFestivale({{$Festivale['id']}})" class="btn btn-secondary">Delete</button>
                              </div>
