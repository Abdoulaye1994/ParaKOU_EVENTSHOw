     ...
     <body>
        ...
        <div class="card">
            <div class="card-body">
              ...
              <form  wire:submit.prevent="hotelsave" >
                ...
                <div class="row mb-3">
                    <label  class="col-sm-2 col-form-label">Nom de l'Hôtel</label>
                    <div class="col-sm-10">
                  ...
                  <div class="row mb-3">
                    <label  class="col-sm-2 col-form-label">Localisation</label>
                    <div class="col-sm-10">
                      <input type="text" class="form-control" wire:model="quartier">
                    </div>
                  </div>
                            ...
                            <table class="table table-striped">
                              ...
                              <tr>
                                ...
                                <th scope="col">
                                    <div class="col-md-10">
                                       <div class="speaker">
                                          <img style="height: 50px; width: 50px;" class="img-fluid" src="{{Storage::url($Hote['image'])}}">
                                       </div>
                                  </div>
                                </th>
                                <th scope="col">
                                ...
                                <th>
                                    <div class="col-sm-2 d-flex">
                                       <button type="submit" value="save"   wire:click="updateHote({{$Hote['id']}})"  class="btn btn-primary">Update</button>
                                       <button type="submit" value="save" wire:click="deleteHote({{$Hote['id']}})" class="btn btn-secondary">Delete</button>
                                      </div>
