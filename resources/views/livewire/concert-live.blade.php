     ...
     <body>
        ...
        <div class="card">
            <div class="card-body">
              ...
              <form  wire:submit.prevent="concertsave" >
                    ...
                    <table class="table table-striped">
                      ...
                      <tr>
                        ...
                        <th scope="col">
                            <div class="col-md-10">
                               <div class="speaker">
                                  <img style="height: 50px; width: 50px;" class="img-fluid" src="{{Storage::url($concert['image'])}}">
                               </div>
                          </div>
                        </th>
                        <th scope="col">
                        ...
                        <th>
                            <div class="col-sm-2 d-flex">
                               <button type="submit" value="save"   wire:click="updateconcert({{$concert['id']}})"  class="btn btn-primary">Update</button>
                               <button type="submit" value="save" wire:click="deleteconcert({{$concert['id']}})" class="btn btn-secondary">Delete</button>
                              </div>
